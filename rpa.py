...
#Linha de código que abre o navegador
...
iniciar_desafio = element = browser.find_element(By.XPATH,"//button[@class='waves-effect col s12 m12 l12 btn-large uiColorButton']")
...
for i, row in df_tabela.iterrows(): 
 ...
 botao.click()
 #função time sleep para dar delay (ver o tempo de conclusão da automação)
 time.sleep(0.5)
